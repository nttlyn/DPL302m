            ...
            for plate in plates:
                for non_helmet in non_helmets:
                    if is_bbox_inside(plate, vehicle) and is_bbox_inside(non_helmet, vehicle):
                            ...
                            folder_evidence = os.path.join(evidence_folder,f'vehicle_{name_result}, {current_time}.jpg')
                            cv2.imwrite(folder_evidence, vehicle_img)

                            folder_plate = os.path.join(plate_folder, f'plate_{name_result}, {current_time}.jpg')
